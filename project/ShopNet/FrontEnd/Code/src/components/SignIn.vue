                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" @submit.prevent="signIn">
                        <div>
                            ...
                            <span class="text-red-400" v-for="error in $v.username.$errors">{{
                                generateCustomValidationMessage(error.$message, "Username") }}</span>
                        </div>
                        <div>
                            <label for="password"
                            ...
                            <span class="text-red-400" v-for="error in $v.password.$errors">{{
                                generateCustomValidationMessage(error.$message, "Password") }}</span>
                        </div>
                        <button type="submit"
...
<style scoped>/* Add any scoped styles here */</style>
