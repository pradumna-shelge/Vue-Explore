          ...
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form class="space-y-4 md:space-y-6" @submit.prevent="signUp">
              <div>
                ...
                <span class="text-red-400 small text-right" v-for="error in $v.username.$errors">{{ CustomValidationMsg(error.$message,"Username")  }}</span>
              </div>
              <div>
                ...
                <span class="text-red-400 small text-right" v-for="error in $v.password.$errors">{{ CustomValidationMsg(error.$message, "Password")  }}</span>
              </div>
              <div>
                ...
                <span class="text-red-400 small text-right" v-for="error in $v.email.$errors">{{ CustomValidationMsg(error.$message, "Email address")  }}</span>
              </div>
